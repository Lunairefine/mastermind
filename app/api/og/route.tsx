          ...
          <div tw="flex flex-col w-full h-full bg-[#1a1a1a] rounded-[30px] border-2 border-[#333333] p-10 relative">
            <div tw="flex justify-between items-center w-full h-16">
              <div tw="flex items-center">
                ...
                />
                <span tw="text-white text-2xl font-black tracking-widest ml-4">
                  MASTERMIND
                </span>
              </div>
              <div tw="flex items-center px-5 py-2 rounded-xl">
            ...
            <div tw="flex flex-col items-center justify-center my-auto">
              <span tw="text-[#888888] text-2xl tracking-[0.25em] font-sans font-bold uppercase m-0">
                TOTAL SCORE
              </span>
